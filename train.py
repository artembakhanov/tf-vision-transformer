...
if __name__ == "__main__":
    ...
    parser.add_argument("--base-lr", default=1e-3, type=float, help="starting learning rate")
    parser.add_argument("--end-lr", default=1e-3, type=float, help="the minimum possible value of learning rate")
